...
class DescribeAssociationCommandTest {
    ...
    void run_callsCorrectEndpoint() {
        when(apiClient.get("/clusters/test-cluster/pod-identity-associations/assoc-abc"))
        ...
        verify(apiClient).get("/clusters/test-cluster/pod-identity-associations/assoc-abc");
    }
