package ai.codriverlabs.eksdx.cli.spi;

import java.util.List;

/**
 * SPI for extending the eks-dx CLI with additional commands.
 *
 * <p>Implementations are discovered via CDI at startup and their commands
 * are registered as subcommands of the top-level {@code eks-dx} command.
 *
