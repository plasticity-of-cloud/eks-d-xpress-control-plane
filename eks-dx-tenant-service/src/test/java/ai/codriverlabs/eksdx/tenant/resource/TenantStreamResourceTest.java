...
import ai.codriverlabs.eksdx.tenant.resource.TenantStreamResource.ProgressMessage;
...
class TenantStreamResourceTest {
    ...
    void pollProgressQueue_deletesQueueOnReadyState() throws Exception {
        String queueUrl = "https://sqs.us-east-1.amazonaws.com/123456789012/eks-dx-tenant-t1-progress.fifo";
    ...
    void progressQueueName_followsConvention() {
        assertEquals("eks-dx-tenant-abc123-progress.fifo", TenantNaming.progressQueueName("abc123"));
    }
