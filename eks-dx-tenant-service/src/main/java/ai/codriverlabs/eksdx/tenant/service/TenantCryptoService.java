...
public class TenantCryptoService {
    ...
    @ConfigProperty(name = "eks-d-xpress.crypto.kms-ca-key-id")
    String kmsKeyId;
    ...
    public CryptoResult generateAndStore(String tenantId) {
        try {
            ...
            String issuer = "https://eks-dx.codriverlabs.ai/clusters/" + tenantId;
    ...
    private String createKmsSignedCaCert(String tenantId, KeyPair caKeyPair) throws Exception {
        X500Name subject = new X500Name("CN=eks-dx-tenant-" + tenantId + ",O=eks-dx");
