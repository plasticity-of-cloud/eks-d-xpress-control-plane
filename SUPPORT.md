...
- **GitHub Issues**: [Report bugs and request features](https://github.com/plasticity-of-cloud/eks-d-xpress-control-plane/issues)
- **Discussions**: [Ask questions and share ideas](https://github.com/plasticity-of-cloud/eks-d-xpress-control-plane/discussions)
- **Email**: ecosystem@plasticity.cloud

## Feedback

We'd love to hear how you're using EKS-D-Xpress:
...
EKS-D-Xpress is available under the [Elastic License 2.0 (ELv2)](LICENSE.md) for free use.
